  ...
  return (
    <main className="mx-auto flex w-full max-w-6xl flex-1 flex-col gap-5 px-4 py-8">
      <section className="rounded-2xl border border-amber-950/10 bg-white/80 p-5 shadow-sm">
        <h1 className="text-2xl font-semibold text-amber-950">Volunteer Logistics Console</h1>
        <p className="mt-1 text-amber-900/70">Track pickups in real time and execute optimized multi-stop delivery routes.</p>
      </section>
      <StatusPoller />
      <section className="rounded-2xl border border-amber-950/10 bg-white/80 p-5 shadow-sm">
